...
import com.bliblifuturebackend.bliblimart.command.GetPromoProductsCommand;
...
@Service
public class GetPromoProductsCommandImpl implements GetPromoProductsCommand {
    ...
    public Mono<List<ProductResponse>> execute(PagingRequest request) {
        ...
        return productRepository.findByDiscountGreaterThanAndBlimartIdOrderByDiscountDesc(0, request.getBlimartId(), pageable)
